...
static const CGFloat kVideoControlBarHeight = 40.0; //导航高度？
static const CGFloat kVideoControlAnimationTimeinterval = 0.3;  //反应时间
static const CGFloat kVideoControlTimeLabelFontSize = 10.0;   //显示时间的文本的字体大小
static const CGFloat kVideoControlBarAutoFadeOutTimeinterval = 5.0;

@interface KrVideoPlayerControlView()

@property (nonatomic, strong) UIView *topBar; //顶部导航
@property (nonatomic, strong) UIView *bottomBar; //顶部导航
@property (nonatomic, strong) UIButton *playButton; //播放按钮
@property (nonatomic, strong) UIButton *pauseButton; //暂停按钮
@property (nonatomic, strong) UIButton *fullScreenButton; //全屏播放按钮
@property (nonatomic, strong) UIButton *shrinkScreenButton; //全屏缩小按钮
@property (nonatomic, strong) UISlider *progressSlider;//滑动条
