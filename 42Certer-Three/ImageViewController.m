...
-(void) ButtonAction:(UIButton*)button {
    ...
    SlideLeftAndRightInit *LeftAndRightInit = [[SlideLeftAndRightInit alloc] init];
    
    //切换视图操作
    MyCATransition *transition = [[MyCATransition alloc] init];
    [transition transition:4 withView:self.view andToOtherControllerType:2];
    [self presentViewController:LeftAndRightInit.deckController  animated:NO completion:nil];
